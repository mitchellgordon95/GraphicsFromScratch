...
CLI_OBJECTS=main.o cli_module.o dispatcher_module.o move_module.o draw_module.o color_module.o read_module.o tiffstat_module.o tiffread_module.o tiffwrite_module.o tiff_utils.o cli_global.o signal_utils.o resize_module.o zoom_module.o select_module.o
